// JavaScript Document
//控制字体大小自适应代码 实现的比例为1rem=40px(640宽度)
 !function(win) {
	 
 	function resize() {
		//var domWidth = domEle.getBoundingClientRect().width;
		/********************************/
		var ro12 = domEle.getBoundingClientRect();
		//var Top = ro12.top;
		//var Bottom = ro12.bottom;
		var Left12 = ro12.left;
		var Right12 = ro12.right;
		var domWidth = ro12.width||Right12 - Left12;
		//var Height = ro12.height||Bottom - Top;
		/********************************/	
		if(domWidth / v > 540){
			domWidth = 540 * v;
		}
