...
class WxPayConf_pub(object):
    ...
    APPSECRET = "6021e0985185092b430c4182db3b3f62"
    #受理商ID，身份标识
    MCHID = "1240046802"
    #商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    KEY = "qinjiwei01zhangwei02wuchen032015"
    ...
    #=======【证书路径设置】=====================================
    #证书路径,注意应该填写绝对路径
    SSLCERT_PATH = "/data1/www/htdocs/592/overwindows/1/cert/apiclient_cert.pem"
    SSLKEY_PATH  = "/data1/www/htdocs/592/overwindows/1/cert/apiclient_key.pem"
...
class UrllibClient(object):
    ...
    def postXmlSSL(self, xml, url, second=30):
        ...
        opener = urllib2.build_opener(HTTPSClientAuthHandler(WxPayConf_pub.SSLKEY_PATH, WxPayConf_pub.SSLCERT_PATH))
